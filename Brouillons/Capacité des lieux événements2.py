...
df = pd.DataFrame(results.items(), columns=['Lieu', 'Capacité'])
...
# Appliquer la fonction à la colonne 'Capacité' pour extraire les nombres
df['Capacité'] = df['Capacité'].apply(extract_numbers)
